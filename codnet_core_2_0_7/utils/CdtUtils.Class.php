...
/**
 * Utilidades.
 * Funciones comunes que sirven para distintos propósitos.
 * 
...
class CdtUtils {
    ...
    /**
     * se ejecuta una url por curl por método GET
     * @param string $url url a invocar
     * @throws GenericException excepción por fallo.
     * @return response
     */
    ...
    /**
     * se ejecuta una url por curl por método POST
     * @param string $url url a invocar
     * @param unknown_type $params parámetros con los valores a enviar por post
     * @throws GenericException excepción por fallo.
     * @return response
     */
    ...
    public static function log($msg, $class=null, $level=null) {
    	...
    	//chequeamos si se está utilizando la librería log4php
    ...
    public static function log_message($msg, $class=__CLASS__) {
        ...
        if (CDT_MESSAGES_LOG) {
        	...
        	if (class_exists('Logger')) {
        		...
        		//TODO ver si se puede hacer una única vez la configuración. 
    ...
    public static function setRequestError(GenericException $ex) {
        ...
        */
        ...
        $_SESSION[APP_NAME]["error_msg"] = $ex->getMessage();
        
    }

    /**
     * obtiene el valor del parámetro de sesión.
    ...
    /**
     * obtiene el valor del parámetro del request x GET.
     * @param string $name nombre del parámetro
     * @param string $default valor por default en caso de no estar seteado
    ...
    /**
     * obtiene el valor del parámetro del request x POST.
     * @param string $name nombre del parámetro
     * @param string $default valor por default en caso de no estar seteado
     * @param $filter si debe aplicarse el inputFilter
     * @param $encode si debe aplicarse el encode al valor.
    ...
    /**
     * evalúa si la cadena $str comienza con la cadena $strPattern
     * @param string $str
    ...
    public static function sendMail($nameTo, $to, $subject, $msg) {

    	//FIXME para tests todos los mails me los envío a mi.
    	$to = "bernardo.iribarne@codnet.com.ar";
