...
class CdtActionController{
	...
	//map helper con el mapeo del archivo de navegación.
	private $map;
	//filtros.
	private $filters;
	...
	public function execute( $ds_actionName='' ){
		...
		if(empty($ds_actionName))
			//obtenemos el action desde el parámetro.
		...
		try{
			...
			//obtenemos la acción a ejecutar (el nombre de la clase).
