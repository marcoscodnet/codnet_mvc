...
class GridRenderer implements IGridRenderer {
    ...
    public function renderHidden( XTemplate $xtpl) {
        ...
        //también seteamos como hidden los filtros que así lo indiquen.
    ...
    /**
     * para filtros definidos específicamente por cada grilla.
     * @param $model
     * @param $xtpl
     */
    ...
    public function renderRowsHeader( XTemplate $xtpl) {
    	...
    	//si hay grupos, los encabezados que no estén agrupados, deben tener rowspan
