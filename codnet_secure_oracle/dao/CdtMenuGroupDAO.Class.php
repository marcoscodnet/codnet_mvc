 ...
 * @since 09-11-2011
 */ 
class CdtMenuGroupDAO { 

	/**
	 * se persiste la nueva entity
	 * @param CdtMenuGroup $oCdtMenuGroup entity a persistir.
	 */
	public static function addCdtMenuGroup(CdtMenuGroup $oCdtMenuGroup) { 
		...
		$sql = "INSERT INTO $tableName (nu_order, nu_width, ds_name, ds_action, ds_cssclass) VALUES($nu_order, $nu_width, '$ds_name', '$ds_action', '$ds_cssclass')"; 
	 ...
	 */
	public static function updateCdtMenuGroup(CdtMenuGroup $oCdtMenuGroup) { 
		$db = CdtDbManager::getConnection(); 
		...
		$sql = "UPDATE $tableName SET nu_order = $nu_order, nu_width = $nu_width, ds_name = '$ds_name', ds_action = '$ds_action', ds_cssclass = '$ds_cssclass' WHERE cd_menugroup = $cd_menugroup "; 
	 ...
	 */
	public static function deleteCdtMenuGroup(CdtMenuGroup $oCdtMenuGroup) { 
		$db = CdtDbManager::getConnection(); 
		...
		$sql = "DELETE FROM $tableName WHERE cd_menugroup = $cd_menugroup "; 
	 ...
	 */
	public static function getCdtMenuGroups(CdtSearchCriteria $oCriteria) { 
	 ...
	 * @return int
	 */
	public static function getCdtMenuGroupsCount(CdtSearchCriteria $oCriteria) { 
		$db = CdtDbManager::getConnection(); 
	 ...
	 * @return CdtMenuGroup
	 */
	public static function getCdtMenuGroup(CdtSearchCriteria $oCriteria) { 
