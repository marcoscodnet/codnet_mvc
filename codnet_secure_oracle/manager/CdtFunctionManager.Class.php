...
class CdtFunctionManager implements ICdtList{ 
	...
	public function addCdtFunction(CdtFunction $oCdtFunction) { 
		...
		CdtFunctionDAO::addCdtFunction($oCdtFunction);
	}
	...
	public function updateCdtFunction(CdtFunction $oCdtFunction) { 
		...
		//persistir en la bbdd.
		CdtFunctionDAO::updateCdtFunction($oCdtFunction);
	}
	...
	public function deleteCdtFunction($id) { 
		...
		foreach ($ids as $next) {
			...
			CdtFunctionDAO::deleteCdtFunction($oCdtFunction);	
		}
	...
	public function getCdtFunctions(CdtSearchCriteria $oCriteria) { 
		return CdtFunctionDAO::getCdtFunctions($oCriteria); 
	}
	...
	public function getCdtFunctionsCount(CdtSearchCriteria $oCriteria) { 
		return CdtFunctionDAO::getCdtFunctionsCount($oCriteria); 
	}
	...
	public function getCdtFunction(CdtSearchCriteria $oCriteria) { 
		return CdtFunctionDAO::getCdtFunction($oCriteria); 
	}
	...
	public static function getCdtUserGroupFunctions(CdtUserGroup $oUserGroup) {
		return CdtFunctionDAO::getCdtUserGroupFunctions( $oUserGroup );
	}
} 
?>
