...
/**
 * se definen los mensajes del sistema en espaï¿½ol.
 * 
 * @author modelBuilder
 * 
 */
...
define('CDT_SECURE_MSG_CDTUSERGROUP_CD_USERGROUP_REQUIRED', 'Código requerido', true);
...
define('CDT_SECURE_MSG_CDTUSERGROUPFUNCTION_TITLE_ADD', 'Agregar Función del Grupo de Usuario', true);
define('CDT_SECURE_MSG_CDTUSERGROUPFUNCTION_TITLE_UPDATE', 'Modificar Función del Grupo de Usuario', true);
define('CDT_SECURE_MSG_CDTUSERGROUPFUNCTION_TITLE_VIEW', 'Visualizar Función del Grupo de Usuario', true);
