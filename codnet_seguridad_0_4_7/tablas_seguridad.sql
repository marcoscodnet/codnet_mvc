...
INSERT INTO `menuoption` VALUES (5, 'AccionFunciones', 'doAction?action=listar_accionfunciones', NULL, 4, 1, 'accionfunciones', 'Acción Funciones');
INSERT INTO `menuoption` VALUES (6, 'Funciones', 'doAction?action=listar_funciones', NULL, 5, 1, 'funciones', NULL);
INSERT INTO `menuoption` VALUES (7, 'Menu Groups', 'doAction?action=listar_menugroups', NULL, 6, 1, 'menugroups', NULL);
INSERT INTO `menuoption` VALUES (8, 'Menu Options', 'doAction?action=listar_menuoptions', NULL, 7, 1, 'menuoptions', NULL);
...
CREATE TABLE `registracion` (
  `cd_registracion` int(11) NOT NULL auto_increment,
  `ds_codigoactivacion` varchar(150) collate utf8_unicode_ci default NULL,
  `dt_fecha` varchar(8) collate utf8_unicode_ci default NULL,
  `ds_nomusuario` varchar(150) collate utf8_unicode_ci default NULL,
  `ds_apynom` varchar(150) collate utf8_unicode_ci default NULL,
  `ds_mail` varchar(150) collate utf8_unicode_ci default NULL,
  `ds_password` varchar(150) collate utf8_unicode_ci default NULL,
...
-- 
-- Filtros para la tabla `registracion`
-- 
ALTER TABLE `registracion`
  ADD CONSTRAINT `registracion_pais_fk` FOREIGN KEY (`cd_pais`) REFERENCES `pais` (`cd_pais`);
