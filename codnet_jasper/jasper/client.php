<?php
	...
	//$webservices_uri = "http://" . JASPER_SEVER_IP . ":8080/jasperserver/services/repository";
	define("WEBSERVICES_URI", "http://" . JASPER_SEVER_IP . ":8080/jasperserver/services/repository");
	
	//$namespace = "http://www.jaspersoft.com/namespaces/php";
	define("NAMESPACE","http://www.jaspersoft.com/namespaces/php");
	...
	function ws_checkUsername($username, $password)
	{
		...
		$info = new SOAP_client(WEBSERVICES_URI, false, false, $connection_params);
		...
		$response = $info->call("list",$params,array('namespace' => NAMESPACE));
	...
	function ws_get($uri, $args = array())
	{
		...
		$params = array("request" => $op_xml );
		$response = $info->call("get",$params,array('namespace' => NAMESPACE));
	...
	*/
	...
	function ws_put()
	{
		...
		$params = array("request" => $op_xml);
		$response = $info->call("put",$params,array('namespace' => NAMESPACE));
