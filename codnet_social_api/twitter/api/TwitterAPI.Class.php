 ...
 */
class TwitterAPI extends OAuth
{
  ...
  protected $userAgent      = 'Twitter (http://github.com/jmathai/twitter-async/tree/)';
  ...
  private function request($method, $endpoint, $params = null)
  {
    ...
    $resp= new TwitterJson(call_user_func(array($this, 'httpRequest'), $method, $url, $params, $this->isMultipart($params)), $this->debug);
...
class TwitterException extends Exception 
{
  public static function raise($response, $debug)
  {
    ...
    {
      case 400:
        throw new TwitterBadRequestException($message, $response->code);
      case 401:
