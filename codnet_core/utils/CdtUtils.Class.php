...
/**
 * Utilidades.
 * Funciones comunes que sirven para distintos prop�sitos.
 * 
...
class CdtUtils {
    ...
    /**
     * se ejecuta una url por curl por m�todo GET
     * @param string $url url a invocar
     * @throws GenericException excepci�n por fallo.
     * @return response
     */
    ...
    /**
     * se ejecuta una url por curl por m�todo POST
     * @param string $url url a invocar
     * @param unknown_type $params par�metros con los valores a enviar por post
     * @throws GenericException excepci�n por fallo.
     * @return response
     */
    ...
    public static function log($msg, $class=null, $level=null) {
    	...
    	//chequeamos si se est� utilizando la librer�a log4php
    ...
    public static function log_message($msg, $class=__CLASS__) {
        ...
        if (CDT_MESSAGES_LOG) {
        	...
        	if (class_exists('Logger')) {
        		...
        		//TODO ver si se puede hacer una �nica vez la configuraci�n. 
    ...
    /**
     * obtiene el valor del par�metro de sesi�n.
    ...
    /**
     * obtiene el valor del par�metro del request x GET.
     * @param string $name nombre del par�metro
     * @param string $default valor por default en caso de no estar seteado
    ...
    /**
     * obtiene el valor del par�metro del request x POST.
     * @param string $name nombre del par�metro
     * @param string $default valor por default en caso de no estar seteado
     * @param $filter si debe aplicarse el inputFilter
     * @param $encode si debe aplicarse el encode al valor.
    ...
    /**
     * eval�a si la cadena $str comienza con la cadena $strPattern
     * @param string $str
    ...
    public static function sendMailPop($nameTo, $to, $subject, $msg) {
        ...
        if (!$mail->Send())
            throw new GenericException("Ocurrió un error en el envío del mail a $nameTo <$to>" . $mail->ErrorInfo);
