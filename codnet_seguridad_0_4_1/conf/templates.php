...
/*login*/
define( 'CDT_SEGURIDAD_TEMPLATE_LOGIN',  CDT_SEGURIDAD_PATH . 'view/templates/login.html' );
...
/*registracion*/
define( 'CDT_SEGURIDAD_TEMPLATE_REGISTRAR_USUARIO',  CDT_SEGURIDAD_PATH . 'view/templates/registrarse.html' );
