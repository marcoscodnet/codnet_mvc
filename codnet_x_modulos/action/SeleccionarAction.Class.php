...
abstract class SeleccionarAction extends ListarAction{
	...
	protected function getXTemplate(){
		...
		if( defined("DEFAULT_BUSCAR_TEMPLATE") )
			return new XTemplate(DEFAULT_BUSCAR_TEMPLATE);
		else
			return new XTemplate(CDT_MVC_TEMPLATE_SELECCIONAR);
	...
	protected function getSeleccionarEnOpener(){
		...
		if( isset( $_GET['seleccionar_en_opener']))
			$seleccionarEnOpener = FormatUtils::getParam('seleccionar_en_opener');
	...
	protected function getOnComplete(){
		...
		if( isset( $_GET['onComplete']))
			$onComplete = FormatUtils::getParam('onComplete');
		return $onComplete;	
	}
