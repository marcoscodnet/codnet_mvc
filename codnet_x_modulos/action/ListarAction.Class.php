...
/**
 * Acciï¿½n listar entidades genï¿½ricas.
 * Cada subclase definirï¿½ la entidad concreta. 
 * 
 * @author bernardo
 * @since 05-03-2010
 * 
 */
abstract class ListarAction extends SecureOutputAction{
	...
	/**
	 * retorna la pï¿½gina para paginaciï¿½n de los resultados.
	 */
	...
	/**
	 * criterio de bï¿½squeda para filtrar el listado.
	 * @return unknown_type
	 */
	...
	/**
	 * @return forward a la pï¿½gina de error.
	 */
	 ...
	 * cada elemento de la lista deberï¿½ ser un array de la forma:
	 *    - vector['nombre']='campo_orden'
	 *    - vector['label']='descripciï¿½n de la ordenaciï¿½n'
	 *    - vector['accion']='descripciï¿½n de la ordenaciï¿½n'
	 * se puede usar el mï¿½todo buildFiltro(orden, descripcion) para formar dicho arreglo.   
	 * @return unknown_type
	 */
	...
	/**
	 * se parsean las opciones del filtro de bï¿½squeda:
	 * opciones del combo.
	 * @param XTemplate $xtpl
	...
	protected function parseOpcionesFiltro(XTemplate $xtpl, $campo){
		...
		//imprimimos el combo y el campo de texto para la bï¿½squeda siempre y cuando se haya definido algï¿½n filtro.
		if($count>0){
	...
	/**
	 * se retorna una lista con los filtros de bï¿½squeda.
	 * cada elemento de la lista deberï¿½ ser un array de la forma:
	 *    - vector['orden']='campo_orden'
	 *    - vector['descripcion']='descripciï¿½n de la ordenaciï¿½n'
	 * se puede usar el mï¿½todo buildFiltro(orden, descripcion) para formar dicho arreglo.   
	 * @return unknown_type
	 */
	 ...
	 *    - th['descripcionOrden']='descripciï¿½n de la ordenaciï¿½n'
	 * se puede usar el mï¿½todo buildTh(nombre, orden, descripcion) para formar dicho arreglo.   
	 * @return unknown_type
	 */
	 ...
	 *    - accion['href']='link'
	 *    - accion['img']='imagen'
	 *    - accion['title']='tï¿½tulo para la imï¿½gen'
	 * se puede usar el mï¿½todo buildAccion(onclick, href, img, title) para formar dicho arreglo.   
	 * @return unknown_type
	 */
	protected function getAcciones($item){}

	/**
	 * construye una acciï¿½n.
	...
	*/
	 ...
	 * @param unknown_type $query_string query de bï¿½squeda para mantener los filtros.
	 * @param unknown_type $encabezado descripciï¿½n del encabezado.
	 * @param unknown_type $campoOrden campo por el cual ordenar el listado al cliquear en el encabezado.
	 * @param unknown_type $descripcionOrden descripciï¿½n de la ordenaciï¿½n.
	 * @return none.
	 */
	...
	/**
	 * se parsea un filtro de bï¿½squeda.
	 * @param $xtpl template a parsear.
	 * @param $value valor para el filtro
	 * @param $descripcion descripciï¿½n del filtro.
	 * @return none.
	 */
	...
	/**
	 * parsea una acciï¿½n en la fila corriente.
	 * @param XTemplate $xtpl template a parsear.
	 * @param unknown_type $onclick evento del onclick.
	 * @param unknown_type $href href del link.
	 * @param unknown_type $img imï¿½gen del link.
	 * @param unknown_type $title descripciï¿½n del link.
	 * @return none.
	 */
	...
	/**
	 * se parsea una opciï¿½n sobre el listado.
	 * es un botï¿½n que aparece arriba del listado.
	 * @param XTemplate $xtpl template a parsear.
	 * @param unknown_type $nombre nombre del botï¿½n.
	 * @param unknown_type $label label del botï¿½n.
	 * @param unknown_type $accion acciï¿½n al ejecutar en el onlick
	 * @return none.
	 */
