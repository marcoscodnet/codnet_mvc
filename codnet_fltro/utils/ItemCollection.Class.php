...
class ItemCollection implements Iterator {
	...
	//Buscar un valor en la colección y retorna una clave
	...
	public function addAll(ItemCollection $items){
	...
	public function fill( $field, $value, $case_sensitive = false) {
		$newRow = array();
		$currents = $this->_items;
	...
	private function match($string, $substring){
